...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user_web/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('user_web/assets/css/templatemo.css') }}">
    <link rel="stylesheet" href="{{ asset('user_web/assets/css/custom.css') }}">
...
<body>
    ...
    <!-- Start Script -->
    <script src="{{ asset('user_web/assets/js/jquery-1.11.0.min.js') }}"></script>
    <script src="{{ asset('user_web/assets/js/jquery-migrate-1.2.1.min.js') }}"></script>
    <script src="{{ asset('user_web/assets/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('user_web/assets/js/templatemo.js') }}"></script>
    <script src="{{ asset('user_web/assets/js/custom.js') }}"></script>
    <!-- End Script -->
</body>
